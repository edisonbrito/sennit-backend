...
using Sennit.Infra.Repositories;
using Sennit.Infra.Transactions;
using Sennit.Shared;
using System;
using System.Text;

namespace Sennit.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<SennitDataContext, SennitDataContext>();
            ...
            services.AddTransient<CouponCommandHandler, CouponCommandHandler>();
            services.AddTransient<CouponUpdateCommandHandler, CouponUpdateCommandHandler>();
        }
